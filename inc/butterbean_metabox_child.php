...
remove_accents('butterbean_register', 'stm_listings_register_manager');
add_action('butterbean_register', 'stm_listings_register_manager_child', 20, 2 );


function stm_listings_register_manager_child( $butterbean, $post_type ) {
