<div class="col-md-4 col-sm-6">
	<div class="stm_price_input">
		...
		<input type="number" class="heading-font" name="stm_van_price" value="<?php echo esc_attr( $leasing_car_price ); ?>" required/>
	</div>
</div>
<div class="col-md-4 col-sm-6">
	<div class="stm_price_input">
		...
		<input type="number" class="heading-font" name="stm_van_price" value="<?php echo esc_attr( $leasing_van_price ); ?>" required/>
	</div>
</div>
