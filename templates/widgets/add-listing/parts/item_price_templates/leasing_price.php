<div class="col-md-4 col-sm-6">
	<div class="stm_price_input">
		<div class="stm_label heading-font"><?php esc_html_e( 'Bil: Leasingydelse pr. mdr.', 'motors-child' ); ?>
...
<div class="col-md-4 col-sm-6">
	<div class="stm_price_input">
		<div class="stm_label heading-font"><?php esc_html_e( 'Van: Leasingydelse pr. mdr.', 'motors-child' ); ?>
			(<?php echo wp_kses_post( stm_get_price_currency() ); ?>)
		</div>
